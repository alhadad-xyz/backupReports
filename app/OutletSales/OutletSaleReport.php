...
class OutletReport extends Dashboard
{
    ...
    protected function content()
    {
        return [
            ...
            Panel::create()->header("Laporan Chart Outlet")->type("danger")->sub([
                OutletChart::create(),
            ]),
            ...
            Panel::create()->header("PDF Export")->type("danger")->sub([
                ...
                ->items([
                    "Export Current Page"=>MenuItem::create()
                        ->onClick(
                            Client::showLoader().
                            Client::widget("OutletTable")->exportToPDF("Products - Current Page",["all"=>false])
                        ),
                    "Export All"=>MenuItem::create()
                        ->onClick(
                            Client::showLoader().
                            Client::widget("OutletTable")->exportToPDF("All Products",["all"=>true])
                        ),
                ])
                ->align("right")
